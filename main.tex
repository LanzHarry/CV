...
\begin{itemize}
  \item ESP32 controlled smart lights and sonos speakers using \cpp and REST API (HUE lights api, sonos api, postman for testing and development, platformio vscode)
  \item Raspberry pi projects home media server, vpn, personal dns, set up using docker, docker compose
\end{itemize}
...
\textbf{Backend \& systems:} Linux, Docker, REST APIs, Networking (TCP, UDP, )
