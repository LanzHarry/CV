...
{\bf Junior Software Engineer with experience in \cpp and Linux systems development, building performance-critical, end-to-end software for real-time data acquisition, hardware control, and large-scale data processing. Strong grounding in networking fundamentals (TCP/UDP), concurrent programming, and high performance computing on Linux.}\\ \vspace{-0.2cm} \hrule
...
\begin{itemize}
  \item Designed and maintained end-to-end, performance-critical software systems in Python and \cpp for a custom MRI platform, operating under real-time and hardware-safety constraints.
...
\begin{itemize}
  \item Implemented a parallel \cpp fluid simulation solver using MPI, focusing on data decomposition, inter-process communication, and performance scaling on Linux HPC clusters.
\end{itemize}
...
\textbf{Programming languages:} Modern \cpp, Python, Go, SQL, Bash

\textbf{Systems \& networking:} Linux (user-space systems programming), TCP/IP, UDP, sockets, REST APIs, Docker, basic networking concepts (DNS, VPNs)
