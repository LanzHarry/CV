...
\vspace{0.2cm}\hrule
{\bf Backend Software Engineer with experience building production-grade distributed systems, data pipelines, and hardware-integrated services. Strong fundamentals in Go, Python, \cpp, Linux, and Docker. Product-minded, comfortable with ambiguity, and experienced owning systems end-to-end.} \\ \vspace{-0.2cm} \hrule
...
\begin{itemize}
  ...
  \item Reduced end-to-end data processing latency by a factor of 10, transforming a batch workflow into an interactive system integrated directly into a user-facing analysis tool.
